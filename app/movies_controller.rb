...
# If there are no arguments are passed, assign default values:
...
def can_find_using_where_clause_and_be_sorted
  Movie.find_by_sql("SELECT * FROM movies WHERE movies.release_date > 2002 ORDER BY release_date DESC ")
